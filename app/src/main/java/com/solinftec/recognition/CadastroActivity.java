...
public class CadastroActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddPersonView = (CustomCameraView) findViewById(R.id.addPerson);
                    ...
                    if((faces != null) && (faces.length == 1)){
                        ...
                        if(((method == MANUALLY) && capturePressed) || (method == TIME)){
                            ...
                            if(total >= numberOfPictures){
                                Intent intent = new Intent(getApplicationContext(), TreinamentoAcitivity.class);
